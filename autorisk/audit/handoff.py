    ...
    handoff_md.write_text(
        "\n".join(
            [
                ...
                "```bash",
                "python -m autorisk.cli audit-handoff-verify -d . --enforce",
                "```",
                "",
                ...
                "```bash",
                "python -m autorisk.cli audit-verify -p PACK.zip --strict \\",
                "  --public-key-dir verifier_bundle/keys/trusted \\",
                "  --revocation-file verifier_bundle/revoked_key_ids.txt \\",
                "  --require-signature --require-public-key --require-attestation",
                "```",
                "",
